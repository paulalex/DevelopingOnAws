package uk.co.developingonaws.storagesolutionswiths3;
...
public class DataTransformer {
	...
	public static final String INPUT_BUCKET_NAME = "www.input-netartmedia.co.uk";

	// TODO 2: Set output bucket name (must be globally unique)
	public static final String OUTPUT_BUCKET_NAME = "www.output-netartmedia.co.uk";
	...
	private static AmazonS3 createS3Client() {
		...
		return AwsS3ClientFacade.createS3Client();
	}
	...
	private static S3Object getObject(AmazonS3 s3ClientForStudentBuckets2, String bucketName, String fileKey) {
		...
		return AwsS3ClientFacade.getObject(s3ClientForStudentBuckets, bucketName, fileKey);
	}
	...
	private static void putObjectBasic(String bucketName, String fileKey, File transformedFile) {
		...
		AwsS3ClientFacade.putObjectBasic(s3ClientForStudentBuckets, OUTPUT_BUCKET_NAME, fileKey, transformedFile);
	}
	...
	private static URL generatePresignedUrl(String bucketName, String objectKey) {
		...
		return AwsS3ClientFacade.generatePresignedUrl(s3ClientForStudentBuckets, bucketName, objectKey);
	}
	...
	private static PutObjectResult putObjectEnhanced(String bucketName, String fileKey, File transformedFile) {
		...
		return AwsS3ClientFacade.putObjectEnhanced(s3ClientForStudentBuckets, bucketName, fileKey, transformedFile);
	}
